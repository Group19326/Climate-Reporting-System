...
#define CHANNEL_ID 1978149 // the channel ID of the channel of our GUI.
#define CHANNEL_API_KEY "H77IJZXJ9VNX05FL" // the channel API KEY of the channel of our GUI.
...
void loop() {
 ...
 digitalWrite(blue, HIGH);
  ...
  ThingSpeak.setField(1, t); //send the DHT22 readings (humidity) to field 1 in thing speak.
  ThingSpeak.setField(2, h);//send the DHT22 readings (temperature) to field 2 in thing speak.
  ...
  // our GUI link:https://thingspeak.com/channels/1978149
}
