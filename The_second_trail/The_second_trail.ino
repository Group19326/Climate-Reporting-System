...
#define CHANNEL_ID 1978201 // the channel ID of the channel of our GUI.
#define CHANNEL_API_KEY "W35WGYO2PKWZCSZ6" // the channel API KEY of the channel of our GUI.
...
void loop() {
 ...
 digitalWrite(blue, HIGH);
  ...
  // our GUI link:https://thingspeak.com/channels/1978201
}
